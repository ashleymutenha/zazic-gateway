...
export default function TablePreP({headings, rowElements}){
    ...
    return (
        ...
        {rowElements!= 0? <TableContainer component={Paper} >
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          ...
          {rowElements.map((element)=>(<StyledTableRow >
                ...
                <StyledTableCell>{element['hivNegative']}</StyledTableCell>
                <StyledTableCell>{element['hivPreP']}</StyledTableCell>
              </StyledTableRow>))}
          </TableBody>
        </Table>
      </TableContainer>:null}
